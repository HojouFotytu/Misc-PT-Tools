...
Download the settings.analyzer.json designed specifically for this tool, from: https://github.com/HojouFotytu/Misc-PT-Tools/tree/master/PT%20Settings-Switcher, and copy it to your PTMagic folder, replacing the default version.
